...
public class MessageConstant {
    ...
    public static final String ADD_ORDERSETTIJG_SUCCESS = "导入预约设置成功";
    public static final String QUERY_ORDERSETTING_SUCCESS = "查询预约设置成功";
    public static final String QUERY_MEMBER_SUCCESS = "查询会员成功";
    public static final String EDIT_ORDERSETTING_SUCCESS = "修改预约设置成功";
    public static final String EDIT_ORDERSETTING_FAIL = "修改预约设置失败";
    public static final String ADD_ORDERSETTIJG_FAIL = "导入预约设置失败";
    ...
    public static final String DELETE_CHECKGROUP_UNABLE = "有关联数据暂时不能删除";
